 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |RM_Nxt|HUE_U | SAT_U| VAL_U|      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |RM_Prv|HUE_D | SAT_D| VAL_D|      |-------.    ,-------|   L  |   D  |   U  |   R  |      |      |
 * |------+------+------+------+------+------| RM_TOG|    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------| PGUP | PGDN |   =  |   +  |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  _______,RM_NEXT, RM_HUEU, RM_SATU, RM_VALU, _______,                    _______,_______,_______,_______,_______,_______,
  _______,RM_PREV, RM_HUED, RM_SATD, RM_VALD, _______,                    KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,_______,_______,
